...
export default function FAQ() {
  return (
    <section className="section">
      ...
      <FaqSection />
      <div className="faq-contact"><div><span className="section-kicker">Une question particulière ?</span><h2>Notre équipe peut vous orienter.</h2></div><Link to="/contact" className="btn btn-primary">Nous contacter</Link></div>
    </section>
  );
}
